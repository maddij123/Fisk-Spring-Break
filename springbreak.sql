...
SELECT u.USER_ID, u.FIRST_NAME, u.LAST_NAME, COUNT(t.TRIP_ID) AS NUM_TRIPS
FROM USERS u
...
CREATE TABLE PACKING_LIST (
	PACKIN_ID INT AUTO_INCREMENT PRIMARY KEY,
    destination_id INT,
    necessity VARCHAR(100),
    FOREIGN KEY (DESTINATION_ID) REFERENCES DESTINATIONS(DESTINATION_ID)
);

INSERT INTO PACKING_LIST (destination_id, necessity)
VALUES 
(1, 'Sunscreen'),
(2, 'A lot of money'),
(3, 'A beach towel'),
